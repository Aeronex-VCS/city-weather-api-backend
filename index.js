...
app.get("/:city", (req, res) => {
    const listTemp = [];
    cities.forEach((val) => {
        if (val.toLowerCase().includes(req.params.city.toLowerCase())) {
            listTemp.push(val);
        }
    });
    res.json({city: listTemp});
});

app.post("/emailSubscribeTecrun", (req, res) => {
    ...
    const transporter = nodemailer.createTransport({
        ...
        secure: false,
        auth: {
            user: "admin@tecrun.tech",
            pass: "nova@0226",
        },
    });
    const y =
        "Dear subscriber,\nYou have successfully subscribed to our newsletters as ";
    const mailOptions = {
        from: "admin@tecrun.tech",
        to: req.body.email,
        subject: "Subscription Confirmation",
        text: y + req.body.email,
    };
    ...
    // console.log(req.url);
    res.writeHead(301, {Location: "https://tecrun.tech"});
    res.end(JSON.stringify(req.body));
});

app.post("/loginTecrun", (req, res) => {
    if (req.body.pass1 == "9567" && req.body.pass2 == "7683") {
        res.writeHead(301, {Location: "https://tecrun.tech/dir/interpol/"});
